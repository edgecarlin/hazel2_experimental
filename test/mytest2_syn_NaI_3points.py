...
if 1==1:
	...
	dlims={'B1':[350.,100.], 'B2': [89.,90.], 'B3':[44.,49.],\
		'tau':[10.,0.02],'v':[0.,0.],'deltav':[4.,7.],'a':[0.2,0.1] ,\
	...
	spe=[]
	line=['-','--']
	for kk,mm in enumerate(['EvolOp','M2','Trap']):
		m1.synthesize(plot='s1',method=mm,fractional=False)
		spe.append(cp.deepcopy(m1.spectrum))
else: 
